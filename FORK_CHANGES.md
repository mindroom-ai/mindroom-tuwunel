...
`docs/rebase-*.md` for the per-rebase log. As of the 2026-07-10 rebase the base
is upstream `v1.8.1`. Two features this fork originally carried — the
room-creation default power-level override and the SSO grant-cookie path
hardening — were merged upstream and dropped from the fork as of the 2026-07-07
rebase.
